class Wizard {
    static async getWizards() {
        ...
        let wizardsOperations = new ZCRM.Wizard.Operations();
        ...
        if (response != null) {
            ...
            if (responseHandler instanceof ZCRM.Wizard.Model.ResponseWrapper) {
            ...
            else if (responseHandler instanceof ZCRM.Wizard.Model.APIException) {
    ...
    static async getWizardById(wizardId, layoutId) {
        ...
        await paramInstance.add(ZCRM.Wizard.Model.GetWizardbyIDParam.LAYOUT_ID, layoutId);
