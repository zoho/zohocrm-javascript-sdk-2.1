class InventoryTemplate {
    static async getInventoryTemplates() {
        ...
        let inventoryTemplatesOperations = new ZCRM.InventoryTemplate.Operations(sortBy, sortOrder, category);

        let paramInstance = new ParameterMap();

        paramInstance.add(ZCRM.InventoryTemplate.Model.GetInventoryTemplatesParam.MODULE, moduleAPIName);
        ...
        if (response != null) {
            ...
            if (responseHandler != null) {
                if (responseHandler instanceof ZCRM.InventoryTemplate.Model.ResponseWrapper) {
                ...
                else if (responseHandler instanceof ZCRM.InventoryTemplate.Model.APIException) {
                    //Get the Status
