class RelatedRecord {
    ...
    static async getRelatedRecords(moduleAPIName, recordId, relatedListAPIName) {
        ...
        let relatedRecordsOperations = new ZCRM.RelatedRecord.Operations(relatedListAPIName, moduleAPIName, null);
    ...
    static async updateRelatedRecords(moduleAPIName, recordId, relatedListAPIName) {
         ...
         * 2 -> Value
         */
        record1.addKeyValue("id", 347706113418019n);
         ...
         * 2 -> Value
         */
        record2.addKeyValue("id", 347706112975008n);
    ...
    static async updateRelatedRecordsUsingExternalId(moduleAPIName, externalValue, relatedListAPIName) {
         ...
         * 2 -> Value
         */
        record2.addKeyValue("Products_External", "TestExternalLead121");
