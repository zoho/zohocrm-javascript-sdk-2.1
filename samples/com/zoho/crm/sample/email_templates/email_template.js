class EmailTemplate {
    static async getEmailTemplates(moduleAPIName) {
        ...
        let emailTemplatesOperations = new ZCRM.EmailTemplate.Operations();

        let paramInstance = new ParameterMap();

        paramInstance.add(ZCRM.EmailTemplate.Model.GetEmailTemplatesParam.MODULE, moduleAPIName);
        ...
        if (response != null) {
            ...
            if (responseHandler != null) {
                if (responseHandler instanceof ZCRM.EmailTemplate.Model.ResponseWrapper) {
                ...
                else if (responseHandler instanceof ZCRM.EmailTemplate.Model.APIException) {
                    //Get the Status
