ZCRM.Field = {
	Model : {
		...
		PickListValue : class{
			 ...
			 * @returns {Long} A BigInt representing the forecastCategory
			 */
			getForecastCategory()	{
			 ...
			 * @param {Long} forecastCategory A BigInt
			 */
		...
		HistoryTracking : class{
			...
			setDurationConfiguredField(durationConfiguredField)	{
				if((durationConfiguredField != null) && (!(durationConfiguredField instanceof ZCRM.Field.Model.Field))){
